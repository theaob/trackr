...
export default function BoardFilters({
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 py-3 border-b border-jira-gray-200">
          ...
          return (
            ...
            >
              {user.avatarUrl ? (
                ...
                <div className="w-7 h-7 rounded-full bg-jira-gray-300 text-jira-gray-800 text-xs font-bold flex items-center justify-center border-2 border-white">
                  {user.name.charAt(0)}
                </div>
              )}
            </button>
